    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hello there LITECHRIS-V2 User! 👋🏻* 

> Do not share your session id with your babe 😂.

 *Thanks for using LITECHRIS-V2 🫂* 
...
externalAdReply: {
title: "Chris Gaaju",
thumbnailUrl: "https://files.catbox.moe/qlej9i.png",
...
{quoted:code })
                            ...
                            let desc = `*Don't Share with anyone this code use for deploy LITECHRIS-V2*\n\n ◦ *Github:* https://github.com/Xchristech/LiteChris-V2`;
                            await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
